...
if temperature < 20:
    activity = "indoor reading or arts and crafts"
...
if is_raining == "yes":
    print("Choose an indoor activity of carry an umbrella!")
...
if homework_time > 60:
    ...
    print("Tak a short break before your", activity)
else:
    needs_break = "no"
...
if has_free_time == "yes":
    final_task = input("What hobby would you like to do today?")
